// Bring-up probe: prints the raw S1/S2 pin levels ("s1 s2\r\n", 0/1) at ~10 Hz on the BL616
// USB-UART (pin 69, 115200 8N1), once with the pins' pull-down and once without (see .cst).
`default_nettype none
module btn_probe (input wire clk27, input wire btn_s1, input wire btn_s2, output wire uart_tx, output wire [5:0] led);
    reg [1:0] a = 0, b = 0;
