...
// Timing for f_clk <= 66 MHz (default 54 MHz = 18.5 ns; 81 MHz leaves ~1 ns read setup):
//   CL = 2, tRCD = 2 (ACT->RW 3 clk), tRP = 2, tRC >= 5, tWR = 2, tMRD = 2
...
// Read data is taken RD_LAT clocks after the READ command was registered (CL 2: word 0 is captured by dq_in at the 2nd edge after READ).
//
    ...
    always @(posedge clk) begin
        ...
        if (rst) begin
            ...
            case (state)
                ...
                S_MRS: begin
                    // BL 8 (A2..0 = 011), sequential (A3 = 0), CL 2 (A6..4 = 010), burst write
                    c = C_MRS; sdram_ba <= 2'b00; sdram_addr <= 11'b000_0010_0011;
                ...
                S_RW: begin
                    ...
                    if (cur_we) begin
                        ...
                        c = C_RD; n <= 0; cnt <= RD_LAT - 1; state <= S_RDATA;
                    end
                end
                S_WDATA: begin
                    dq_out <= wdata;
