...
module async_fifo #(
    ...
    output reg              empty = 1'b1,         // registered, conservative (see below)
    ...
    // The combinational compare fed the reader's decisions through a carry chain and set the
    // pixel clock's critical path (MEASUREMENTS M79).
