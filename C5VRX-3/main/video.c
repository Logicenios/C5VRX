...
esp_err_t video_start(void)
{
     ...
     *
     * This is the identical method used by the proven Seamless Golden 16K
     * reference build. A smarter GDMA-register-based separation is deferred
     * to a separate PR after baseline stability is confirmed.
     *
